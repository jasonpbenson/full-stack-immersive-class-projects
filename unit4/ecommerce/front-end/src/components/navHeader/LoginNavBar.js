...
function LoginNavBar(props){
    ...
    return(
        <div className="login-nav-bar">
            {/* <div className="left-align valign-wrapper">HOUSE OF SPIRITS</div> */}
            <div className="login">
                <button type="submit" className="btn play-button btn-github">Login with github</button>
            </div>    
            <div className="cart">MY CART 0 ITEM - £0.00</div>
        </div>
    )
}
