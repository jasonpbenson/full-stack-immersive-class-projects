...
//the callback will run on every element in the array
//if the calback returns true on any element some will return true
...
//the callback will run on every element
//if all return true every will return true
//if some return true every will return false
...
const inChine = cropInfo.find((aPlant) => {
...
//mutate array:
const ranked = cropInfo.forEach((aPlant) => {
